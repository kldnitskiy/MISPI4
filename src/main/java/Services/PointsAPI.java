...
public class PointsAPI {
   ...
   private Database database;
    ...
    public Response renderPoint(@HeaderParam("Authorization") String authorization, @FormParam("x") String x, @FormParam("y") Float y, @FormParam("r") String r, @Context HttpServletRequest req, @Context HttpServletResponse resp) throws IOException, SQLException, NamingException, AttributeNotFoundException, InstanceNotFoundException, InvalidAttributeValueException, MalformedObjectNameException, MBeanException, ReflectionException {
